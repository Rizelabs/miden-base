...
pub const ACCOUNT_SEND_ASSET_MAST_ROOT: &str =
    "0xc5740bad4e353fda39044d29436beb899629667fc57381aaf7971d664712ef5c";
...
pub const ACCOUNT_CREATE_PUBLIC_NOTE_MAST_ROOT: &str =
    "0x2954c205179f44277730f8976991c863e34abed0cb56b0078d516cd17795ba13";
...
pub fn mock_account_code(assembler: &Assembler) -> AccountCode {
    ...
    assert_eq!(code.procedures()[0].to_hex(), ACCOUNT_RECEIVE_ASSET_MAST_ROOT);
    assert_eq!(code.procedures()[1].to_hex(), ACCOUNT_SEND_ASSET_MAST_ROOT);
    assert_eq!(code.procedures()[2].to_hex(), ACCOUNT_INCR_NONCE_MAST_ROOT);
    assert_eq!(code.procedures()[3].to_hex(), ACCOUNT_SET_ITEM_MAST_ROOT);
    assert_eq!(code.procedures()[4].to_hex(), ACCOUNT_SET_CODE_MAST_ROOT);
    assert_eq!(code.procedures()[5].to_hex(), ACCOUNT_CREATE_PUBLIC_NOTE_MAST_ROOT);
    assert_eq!(code.procedures()[6].to_hex(), ACCOUNT_ACCOUNT_PROCEDURE_1_MAST_ROOT);
    assert_eq!(code.procedures()[7].to_hex(), ACCOUNT_ACCOUNT_PROCEDURE_2_MAST_ROOT);
